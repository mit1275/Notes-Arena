...
function sortChildren(dataItem, sort, subItemsField) {
    ...
    if (dataItem[subItemsField]) {
        var item = children(dataItem, subItemsField, kendo_data_query_1.orderBy(children(dataItem, subItemsField), sort));
...
function orderBy(data, descriptors, subItemsField) {
    var sorted = kendo_data_query_1.orderBy(data, descriptors);
...
function filterChildren(dataItem, filters, subItemsField) {
    ...
    if (subItems && subItems.length) {
        ...
        var filtered = kendo_data_query_1.filterBy(subItems, filter);
