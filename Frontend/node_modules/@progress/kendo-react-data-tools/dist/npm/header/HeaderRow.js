...
var HeaderRow = /** @class */ (function (_super) {
    ...
    function HeaderRow() {
        ...
        _this.cells = function (rowIndexes) { return rowIndexes.map(function (columnIndex, index) {
            ...
            return (React.createElement(HeaderThElement_1.HeaderThElement, { ariaSort: sortable ? ariaSortMap[sortDir] : undefined, key: index, colSpan: column.colSpan, rowSpan: column.rowSpan, className: className, style: style, columnId: column.id, navigatable: column.navigatable, onKeyDown: sortable && (function (e) { return _this.cellKeyDown(e, column); }) || undefined },
